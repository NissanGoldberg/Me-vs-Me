...
public class Question_old {
    ...
    public Question_old(Question_old new_question){
    ...
    public Question_old(String answer1, String answer2, String answer3, String answer4, String level, String question, String rightAnswer) {
